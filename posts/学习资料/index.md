...
- 博客
  - [构建我的被动收入](https://www.bmpi.dev/dev/)
  - [为什么这么设计系列文章](https://draven.co/whys-the-design/)
- 优质资料
  - [我的计算机学习网站集合](https://github.com/sanbuphy/my-awesome-cs)
...
- 书籍
  - [《Effective Modern C++ 》翻译版](https://github.com/CnTransGroup/EffectiveModernCppChinese)
  - [《Effective Modern C++》解读笔记](https://www.yuque.com/jtcheng/emcpp)
  - [《Effective Debugging》中文版](https://github.com/Celthi/effective-debugging-zh)
  - [《现代 C++ 教程：高速上手 C++ 11/14/17/20（第二版）》](https://changkun.de/modern-cpp/)
  - [《C++ Primer 中文版（第5版）》笔记和习题](https://github.com/applenob/Cpp_Primer_Practice)
...
- [Modern CPP Tricks](https://github.com/rachitiitr/modern-cpp-tricks)
...
- [mmcgrana/gobyexample](https://github.com/mmcgrana/gobyexample)：使用带注释的示例程序进行 Go 操作的实践介绍。
    - [Go by Example](https://gobyexample.com/)
- [quii/learn-go-with-tests](https://github.com/quii/learn-go-with-tests)：通过编写测试学习 Go 语言。
...
- Linux
  ...
  - [Arch Linux 安装使用教程](https://github.com/ArchLinuxStudio/ArchLinuxTutorial)
  - [Linux网络编程与加密](https://github.com/ArchLinuxStudio/LinuxNetworkProgrammingAndEncryption)
  - [LinuxGuide](https://github.com/ZJDoc/LinuxGuide)：Linux系统配置、工具使用、脚本语法以及访问控制。
- 代码风格
...
- [Coding Interview University](https://github.com/jwasham/coding-interview-university)：
    - [中文](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-cn.md)
...
- [pytorch handbook](https://github.com/zergtant/pytorch-handbook): 帮助那些希望和使用PyTorch进行深度学习开发和研究的朋友快速入门。
- [【关于 NLP】那些你不知道的事](https://github.com/km1994/nlp_paper_study)
- [【关于 NLP】百问百答](https://github.com/km1994/NLP-Interview-Notes)
- [Start Machine Learning in 2021](https://github.com/louisfb01/start-machine-learning): 2021 年开始和改进机器学习 (ML)、人工智能 (AI) 的完整指南，无需任何该领域的背景，并随时了解最新消息和最先进技术！
- [PyTorch 中文手册](https://github.com/zergtant/pytorch-handbook): 这是一本开源的书籍，目标是帮助那些希望和使用PyTorch进行深度学习开发和研究的朋友快速入门。
- [【关于 NLP】 那些你不知道的事](https://github.com/km1994/nlp_paper_study): 研读顶会论文，复现论文相关代码
- [PythonAiRoad](https://github.com/lyhue1991/PythonAiRoad)
...
- [Darling](https://github.com/darlinghq/darling): Darling is a runtime environment for macOS applications.
- [scrcpy](https://github.com/Genymobile/scrcpy): 显示和控制您的 Android 设备。
- [Tesseract OCR](https://github.com/tesseract-ocr/tesseract): Tesseract 开源 OCR 引擎。
- [PDF.js](https://github.com/mozilla/pdf.js): 使用 HTML5 构建的 PDF 查看器。
